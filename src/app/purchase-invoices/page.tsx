...
import PurchaseInvoicesFilters from "@/components/invoices/PurchaseInvoicesFilters";
...
export default function PurchaseInvoicesPage() {
  ...
  useEffect(() => {
    const fetchInvoices = async () => {
      ...
      try {
        ...
        if (!response.ok) {
          throw new Error("فشل في جلب بيانات فواتير الشراء");
        }
        ...
        let errorMessage = "حدث خطأ أثناء تحميل فواتير الشراء";
  ...
  const getStatusBadgeColor = (invoice: PurchaseInvoice) => {
    if (invoice.isPaid) {
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-2">فواتير الشراء</h1>
        <p className="text-gray-600">
          إدارة فواتير الشراء الخاصة بالموردين وتتبع حالة المدفوعات.
        </p>
      </div>
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <div className="relative">
              <input
                type="search"
                placeholder="البحث عن فاتورة شراء..."
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent dir="rtl">
          <DialogHeader>
            <DialogTitle>تأكيد حذف فاتورة الشراء</DialogTitle>
          </DialogHeader>
          <p className="py-4">
            هل أنت متأكد من حذف فاتورة الشراء هذه؟ هذا الإجراء لا يمكن التراجع
            عنه.
          </p>
